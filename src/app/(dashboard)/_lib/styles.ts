...
export const floatingPanel = {
    base: 'bg-[#f7f7f8] rounded-2xl shadow-[0_0_0_1px_rgba(0,0,0,0.06),0_8px_24px_rgba(0,0,0,0.15)]',
    small: 'bg-[#f7f7f8] rounded-2xl shadow-[0_0_0_1px_rgba(0,0,0,0.06),0_6px_20px_rgba(0,0,0,0.15)]',
}
